...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Checked='True') on item 'Configuration.UseIBM500StandardForEBCDICConversi'.", repo.Configuration.UseIBM500StandardForEBCDICConversiInfo, new RecordItemIndex(9));
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'ibm500.txt' with focus on 'SaveAs.Text1001'.", repo.SaveAs.Text1001Info, new RecordItemIndex(15));
            repo.SaveAs.Text1001.PressKeys("ibm500.txt");
            Delay.Milliseconds(0);
