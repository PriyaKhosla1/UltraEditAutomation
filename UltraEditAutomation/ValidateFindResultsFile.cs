...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeContains (WindowText>$ValidateText) on item 'Uedit64.File'.", repo.Uedit64.FileInfo, new RecordItemIndex(4));
            Validate.AttributeContains(repo.Uedit64.FileInfo, "WindowText", ValidateText);
            Delay.Milliseconds(0);
